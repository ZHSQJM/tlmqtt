...
public class TlMqttPubRecReq extends AbstractTlMessage {
    ...
    public static TlMqttPubRecReq build(Long messageId,byte reasonCode,String reasonString, List<UserProperty> userProperties,MqttVersion version) {
        ...
        TlMqttPubRecVariableHead variableHead = TlMqttPubRecVariableHead.builder().messageId(messageId)
        ...
        return TlMqttPubRecReq.builder()
                              .fixedHead(fixedHead)
